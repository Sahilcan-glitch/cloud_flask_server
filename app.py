...
# In-memory store for all messages (resets if app restarts)
logs = []
...
def log_data():
    """
    Expected JSON structure, for example:
    {
        "group_id": 1,
    ...
    entry = {
        ...
        "note": data.get("note"),
        "raw": data,  # full payload in case you want more fields
    }
...
if __name__ == "__main__":
    # For local testing only; Render will use gunicorn in production
